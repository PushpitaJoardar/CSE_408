...
import FlashCardSection from './components/pages/FlashCardSection';
import host_event from './components/pages/host_event';
    ...
    return (
      <>
        ...
        <Routes>
          ...
          <Route exact path = "/type_mcq/quizcategory/:category/Flashcard" element = {<FlashCardSection/>}/>
          <Route exact path = "/host_event" element = {<host_event/>}/>
